...
fn code_block(lang: &str, code: &str) -> String {
    let inner = match lang {
        "" | "ddsl" => ddsl_to_html(code),
        "sql" => sql_to_html(code),
        _ => escape(code),
    };
    let label = if lang.is_empty() { "ddsl" } else { lang };
    format!(
...
<header class="topbar">
  <a class="brand" href="index.html"><span class="brand-mark">DDSL</span></a>
  <nav class="topnav">
        {nav}
  </nav>
  <a class="repo" href="https://github.com/misebox/ddsl">GitHub</a>
</header>
<div class="shell">
...
<footer class="foot">
  <p><strong>Data Definition Schema Language</strong> is a DSL for Database Schema Design.</p>
</footer>
</body>
</html>
"##,
