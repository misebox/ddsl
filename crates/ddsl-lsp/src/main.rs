...
use ddsl_core::ast::Document;
use ddsl_core::dialect;
use ddsl_core::{Severity, parse, resolve};
...
impl LanguageServer for Backend {
    ...
    async fn initialized(&self, _: InitializedParams) {
        self.client
            .log_message(MessageType::INFO, "ddsl-lsp ready")
            .await;
    }
...
fn block_symbol(
    a: &Analyzed,
    name: &str,
    span: ddsl_core::span::Span,
    name_span: ddsl_core::span::Span,
    kind: SymbolKind,
) -> DocumentSymbol {
    DocumentSymbol {
        name: name.into(),
