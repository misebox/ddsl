...
COMMENT ON COLUMN order_items.order_id IS '親の注文';
COMMENT ON COLUMN order_items.product_id IS '対象の商品';
...
COMMENT ON COLUMN posts.user_id IS '投稿者';
COMMENT ON COLUMN posts.category_id IS '所属カテゴリ';
